 ...
 * http://www.princeton.edu/~achaney/tmve/wiki100k/docs/Merge_sort.html Merge Sort coded on :
 * -http://en.wikibooks.org/wiki/Algorithm_Implementation/Sorting/Merge_sort
 * -http://rosettacode.org/wiki/Sorting_algorithms/Merge_sort Merge sort is an O(n log n)
 * comparison-based sorting algorithm. Most implementations produce a stable sort, meaning that the
 * implementation preserves the input order of equal elements in the sorted output. It is a divide
 * and conquer algorithm. Merge sort was invented by John Von Neumann in 1945.
 */
