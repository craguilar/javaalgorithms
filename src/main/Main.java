...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<26;i++){
            if(dic[i]>0)
                System.out.println(Character.toString ((char) (i+'a'))+"("+dic[i]+")>"+dic[i]*(i+1));
        }
        */
    ...
    public static void main(String[] args) throws UnsupportedEncodingException, FileNotFoundException, IOException {
        ...
        //String[] al={"CARLOS","RAQUEL","ALAINA"}; 
        //for(int i=0;i<8192*32;i++){a=a+"a";}
        //MyStringBuffer sb= new MyStringBuffer(a);
