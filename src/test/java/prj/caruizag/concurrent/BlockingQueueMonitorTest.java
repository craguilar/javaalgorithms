...
public class BlockingQueueMonitorTest {
  ...
  @Test
  public void testCorrectnessWithExecutorServiceWithRightPool()
    ...
    Callable<Integer> consumer1 = () -> {
      ...
      try {
        for (int i = 0; i < 25; i++) {
          ...
          System.out.println(
              Thread.currentThread().getName() + " Consumer 1 dequeued: " + lastReadResource);
        }
    ...
    Callable<Integer> consumer2 = () -> {
      ...
      try {
        for (int i = 0; i < 25; i++) {
          lastReadResource = queue.dequeue();
          System.out.println(
              Thread.currentThread().getName() + " Consumer 2 dequeued: " + lastReadResource);
        }
      } catch (InterruptedException ie) {
  ...
  @Test
  public void testCorrectnessWithExecutorServiceWithNotStarvingPool()
      throws InterruptedException, ExecutionException {
