...
import prj.caruizag.algorithms.dp.DynamicProgramming.Item;
...
public class DynamicProgrammingTest {
  ...
  public void coinChange2TestDeepLoopIn() {
    ...
    assertEquals(21,
        DynamicProgramming.coinChangeTopDown(new int[] {58, 92, 387, 421, 194, 208, 231}, 7798));
    assertEquals(16,
        DynamicProgramming.coinChangeTopDown(new int[] {389, 46, 222, 352, 4, 250}, 5343));
